...
public final class TableDescriptor {
    ...
    public Builder toBuilder() {
        final Builder descriptorBuilder = new Builder();
        descriptorBuilder.schema = schema;
        descriptorBuilder.options.putAll(options);
        descriptorBuilder.partitionKeys.addAll(partitionKeys);
        descriptorBuilder.comment = comment;
        return descriptorBuilder;
    }
